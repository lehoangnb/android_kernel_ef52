...
#define FEATURE_PANTECH_MMP_ENHANCE_OGGEXTRACTOR  
 ...
 /************************************************************************
   2014/07/07 P16109 KSJB 
 -  specific clip which of stts value is overflow.
************************************************************************/
#define FEATURE_PANTECH_MMP_Overflow_stts
 
 /************************************************************************
  2014/09/01 Youngjoon Kim
 - enhance low decoding performance for .MTS file because vidc frequency is reduced
 - Qcom code aurora 
    - "mm-video: vdec: synchronize set_framerate with ETB"
    - "mm-video: vidc: Stop setting frame rate on ETB"
************************************************************************/ 
#define FEATURE_PANTECH_MMP_STOP_SET_FRAME_RATE
