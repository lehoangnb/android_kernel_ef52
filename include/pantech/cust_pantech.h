...
**  Log & dump & Debug
*******************************************************************************/
#define FEATURE_PANTECH_ERR_CRASH_LOGGING_USB
#define FEATURE_PANTECH_ERR_CRASH_LOGGING

/************************************************************************** 
** this feature is dummy. you do not use this feature.  (FEATURE_PANTECH_DEBUG_ON)           *
** this feature is used to just delete few configure when build environment is user-build-mode.  *
***************************************************************************/
#ifndef T_BUILD_USER
#define FEATURE_PANTECH_DEBUG_ON
#endif

#ifdef FEATURE_PANTECH_DEBUG_ON
    #define FEATURE_PANTECH_DEBUG //p14291
    #define FEATURE_QC_ABNORMAL_DEBUG_CODE // (+) p16652
#endif

//#define FEATURE_PANTECH_MDM_F3_TRACE_LOG_DEFAULT_ENABLE
...
**  Call PROTOCOL
*******************************************************************************/
/* 2011-10-31 octopusy added  [PS1 Team Feature] */
