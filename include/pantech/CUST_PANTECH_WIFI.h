...
#define FEATURE_PS_WIFI
    ...
    || defined(EF63S) || defined(T_EF63S)|| defined(T_EF65S) || defined(T_EF48S)
    ...
    || defined(EF63K) || defined(T_EF63K) || defined(T_EF49K)
    ...
    || defined(EF63L) || defined(T_EF63L) || defined(T_EF50L)
...
#define FEATURE_PS_WIFI_STA_PERF_SKIP_TEMP_SSID_DISABLE
...
/* 20140619 by seo.hyunseok - immediately reconnect after profile remove */
#define FEATURE_PS_WIFI_STA_PERF_RECONNECT_AFTER_PROFILE_REMOVE
...
/* wqe logging for the debugging*/
//#define FEATURE_PS_WQE_COM_PREF_LOGGING
...
#if defined(T_EF51S) || defined(T_EF52S) || defined(T_EF56S) || defined(EF56S) || defined(T_EF59S) || defined(EF60S) || defined(T_EF60S) || defined(T_EF65S) ||defined(T_EF48S)
	#define FEATURE_SKY_WIFI_VENDOR_SKT
#elif defined(T_EF51K) || defined(T_EF52K) || defined(T_EF57K) || defined(EF57K) || defined(T_EF59K) || defined(EF61K) || defined(T_EF61K) || defined(T_EF49K)
	#define FEATURE_SKY_WIFI_VENDOR_KT
#elif defined(T_EF51L) || defined(T_EF52L) || defined(T_EF58L) || defined(EF58L) || defined(T_EF59L) || defined(EF62L) || defined(T_EF62L) || defined(T_EF50L)
	#define FEATURE_SKY_WIFI_VENDOR_LGU
#endif	
